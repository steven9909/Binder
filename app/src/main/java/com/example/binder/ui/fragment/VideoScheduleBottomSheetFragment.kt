...
import data.VideoScheduleBottomSheetConfig
import org.koin.androidx.viewmodel.ext.android.viewModel
import viewmodel.InputScheduleBottomSheetViewModel
import viewmodel.VideoScheduleBottomSheetViewModel
import java.text.SimpleDateFormat
import java.util.*

class VideoScheduleBottomSheetFragment(override val config: VideoScheduleBottomSheetConfig) : BaseBottomSheetFragment(){
    override val viewModel: ViewModel by viewModel<VideoScheduleBottomSheetViewModel>()
